...
function PerfilContato({route, navigation} : Props): JSX.Element {
    ...
    async function atualizar() {
        try {
            ...
            await DatabaseConfiguration.atualizar(
                id,
                nome,
                sobrenome,
                DDD,
    ...
    async function excluir() {
        try {
            await DatabaseConfiguration.delete(
                id,
            )
    ...
    return (
        <ScrollView>
            <View>
                ...
                <Label>DDD</Label>
                <Input keyboardType="number-pad"  value={DDD} onChangeText={setDDD}  placeholder="DDD" />
                <Label>Telefone</Label>
                <Input keyboardType="number-pad" value={telefone} onChangeText={setTelefone}  placeholder="Telefone" />
